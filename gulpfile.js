...
gulp.task('js_libs', function () {
    ...
    var backToTop = 'app/resources/js/back_to_top.js';
...
gulp.task('css_libs', function(){
    ...
    var landing = 'app/resources/css/landing.css';
...
gulp.task('js_nglibs', function () {
    ...
    var backToTop = 'app/resources/js/back_to_top.js';
    var calendar = 'app/resources/js/calendar.js';
    var app = 'app/resources/programar/src/js/*.js';
...
gulp.task('assets_hoja-diaria', function () {
    ...
    var jqueryui = 'bower_components/jqueryui/jquery-ui.js';
    var calendar = 'app/resources/js/calendar.js';
    var table = 'app/resources/js/hoja_diaria/table.js';
    var create = 'app/resources/js/hoja_diaria/create.js';
    var ajaxBlocks = 'app/resources/js/ajaxBlocks.js';
    ...
    var cssHojaDiaria = 'app/resources/css/hoja-diaria_create.css';
    ...
    gulp.src('app/resources/js/hoja_diaria/index.js')
...
gulp.task('assets_reportes', function(){
    ...
    var cssReporte = 'app/resources/css/reporte.css';
    ...
    gulp.src('app/resources/json/Spanish.json')
    ...
    var param = 'app/resources/js/r.param.js';
    ...
    var deposito = 'app/resources/js/r.deposito.js';
...
gulp.task('js_pages', function () {
    ...
    gulp.src('app/resources/js/ajaxBlocks.js')
        .pipe(concat('ajaxblocks.js'))
        .pipe(uglify())
        .pipe(gulp.dest('public/dist/js/'));
    console.log('copy [app/resources/js/ajaxBlocks.js] to dist/js/ajaxblocks.js');

    gulp.src('app/resources/js/hoja_diaria/modal/formDesvio.js')
        .pipe(concat('formdesvio.js'))
        .pipe(uglify())
        .pipe(gulp.dest('public/dist/js/'));
    console.log('copy [app/resources/js/hoja_diaria/modal/formDesvio.js] to dist/js/formdesvio.js');

    gulp.src('app/resources/js/hoja_diaria/modal/formDesviador.js')
        .pipe(concat('formdesviador.js'))
        .pipe(uglify())
        .pipe(gulp.dest('public/dist/js/'));
    console.log('copy [app/resources/js/hoja_diaria/modal/formDesviador.js] to dist/js/formdesviador.js');

    gulp.src('app/resources/js/hoja_diaria/modal/formMaterialCol.js')
        .pipe(concat('formmaterialcol.js'))
        .pipe(uglify())
        .pipe(gulp.dest('public/dist/js/'));
    console.log('copy [app/resources/js/hoja_diaria/modal/formMaterialCol.js] to dist/js/formmaterialcol.js');

    gulp.src('app/resources/js/hoja_diaria/modal/formMaterialRet.js')
        .pipe(concat('formmaterialret.js'))
        .pipe(uglify())
        .pipe(gulp.dest('public/dist/js/'));
    console.log('copy [app/resources/js/hoja_diaria/modal/formMaterialRet.js] to dist/js/formmaterialret.js');

    gulp.src('app/resources/js/hoja_diaria/modal/formTrabajo.js')
        .pipe(concat('formTrabajo.js'))
        .pipe(uglify())
        .pipe(gulp.dest('public/dist/js/'));
    console.log('copy [app/resources/js/hoja_diaria/modal/formTrabajo.js] to dist/js/formTrabajo.js');
...
gulp.task('html', function () {
    ...
    gulp.src('app/resources/programar/src/templates/*')
        .pipe(gulp.dest('public/dist/html/'));
    console.log('copy [app/resources/programar/src/templates/*] to dist/html/*');
});
