...
<div class="row">
	...
	<fieldset>
		...
		<div class="form-group col-md-4">
			...
			<div class="controls">
				{{ Form::select('selectblock', $blocks, null, [ 'class' => 'myselect', 'id'=>'selectblock', 'data-live-search'=>'true']) }}
			</div>
		</div>
		{{-- Grupo Vía
		===================================================== --}}
		<div class="form-group col-md-4">
			...
			<div class="controls">
				{{ Form::text('grupo_via', null, array('placeholder' => '', 'class' => 'form-control')) }}
			</div>
		</div>
			...
			<table class="table table-bordered table-striped" id="tab_trabajados">
				...
				<tbody>
					<tr id='addr0' data-id="0" class="hidden">
						...
						{{ Form::select('selecttrabajo[0]', $trabajos, null, [ 'class'=>'myselect selecttrabajo', 'id'=>'selecttrabajo[0]']) }}</td>
						<td data-name="selectubicacion[">
						{{ Form::select('selectubicacion[0]', ['Seleccione Sector y Block'], null, [ 'class'=>'myselect selectubicacion', 'id'=>'selectubicacion[0]']) }}</td>
