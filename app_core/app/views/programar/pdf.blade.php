    ...
    <div>
        <table>
            ...
            <tr>
                ...
                @else
                <td></td>
                @endif @if($trabajo->mar == 'checked')
                <td class="checked"></td>
                @else
                <td></td>
                @endif @if($trabajo->mie == 'checked')
                <td class="checked"></td>
                @else
                <td></td>
                @endif @if($trabajo->juv == 'checked')
                <td class="checked"></td>
                @else
                <td></td>
                @endif @if($trabajo->vie == 'checked')
                <td class="checked"></td>
                @else
                <td></td>
                @endif @if($trabajo->sab == 'checked')
                <td class="checked"></td>
                @else
                <td></td>
                @endif @if($trabajo->dom == 'checked')
                <td class="checked"></td>
                @else
                <td></td>
                @endif
